...
public class JWTGenerateValidateRSA {
    ...
    public static void main(String[] args) throws InvalidKeySpecException, NoSuchAlgorithmException {
      ...
      //  System.out.println("public  " + publicKey);
        System.out.println("Signed with Private " + jwt);
    ...
    public static Jws<Claims> parseJwt(String jwtString) throws InvalidKeySpecException, NoSuchAlgorithmException {
       ...
       // PublicKey publicKey = getPublicKey();
    	...
    	/*JwtParser jwtPub = Jwts.parserBuilder()
                .setSigningKey(publicKey).build();
    	
    	Jws<Claims> jwt = jwtPub.parseClaimsJws(jwtString);*/
        return jwt;
    }
   ...
   //     PrivateKey privateKey = getPrivateKey();
        ...
        String jwtToken = Jwts.builder()
                .claim("name", "Anand Kidambi")
                .claim("email", "anand@example.com")
                .setSubject("Anand")
